...
@Component
public class EntityMongoDatabaseFactory implements MongoDatabaseFactory {

  private final EntityMongoDBResolver resolver;
  ...
  public EntityMongoDatabaseFactory(EntityMongoDBResolver resolver,
  ...
  public MongoDatabaseFactory withSession(ClientSession session) {
    EntityMongoDatabaseFactory outer = this;
